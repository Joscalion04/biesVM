...
public class biesParser extends Parser {
	...
	public static final int
		RULE_start = 0, RULE_inst = 1, RULE_mnemonic = 2, RULE_arg = 3;
	private static String[] makeRuleNames() {
		return new String[] {
			"start", "inst", "mnemonic", "arg"
		};
	}
	...
	public biesParser(TokenStream input) {
		super(input);
	...
	public static class ArgContext extends ParserRuleContext {
		public TerminalNode INT() { return getToken(biesParser.INT, 0); }
		public TerminalNode STR() { return getToken(biesParser.STR, 0); }
